...
public class DsidError {
    ...
    static public final String CODE_X_BIND_REQUIRED_4 = "0C090D10";
    ...
    public static DsidError parseDiagnosticMessage(String diagnosticMessage) {
        ...
        switch (codeString) {
            ...
            case CODE_X_BIND_REQUIRED_3:
                ...
                //
                // MID-9724
                return new DsidError(CODE_X_BIND_REQUIRED_3, "Connection was unbound on the server", diagnosticMessage,
                        ReconnectException.class);

            case CODE_X_BIND_REQUIRED_4:
                // 000004DC: LdapErr: DSID-0C090D10, comment: In order to perform this operation a successful bind must be completed on the connection., data 0, v4f7c?: X_BIND_REQUIRED: In order to perform this operation a successful bind must be completed on the connection
                //
                // Looks like something on the server has "logged out" the connection, while LDAP channel remains active.
                return new DsidError(CODE_X_BIND_REQUIRED_4, "Connection was unbound on the server", diagnosticMessage, ReconnectException.class);
